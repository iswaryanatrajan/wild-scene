...
<!--<li><a href="https://wild-scene.com">New Menu<span>New Menu</span></a></li>-->
                          ...
                          <table class="table table-noborder " style="border:none">
                            <tr>
                              ...
                              <td style="width:20%;vertical-align: middle" rowspan="2" >
                                <img src="header4.png" style="left:50px;    right: 0px;"/>
                              </td>
                            </tr>
                            <tr>
        ...
        <div class="row section4 mb-5">
          <div class="col-7">
            ...
            <p class="p-contents04__blockTxt">
              ...
              しかし、ワイルドシーンのライフジャケットは安全性の追求にこだわり、これらの条件よりも厳しい国際基準IMOに準拠した規格で気室を開発しました。<br>	
              【約3日間の持続力】<br>
              結果、気室における二酸化炭素減少率の比較実験で、膨張後72時間経過しても減少率を約0%に近づけることに成功。<br>	
              つまり、日本国内の基準を満たしただけの製品よりも水中で浮かんでいられる日数も長く、救助までの時間を延ばせるといえます。<br>	
              【法定基準を上回る浮力】<br>
      ...
      <div class="row section4 mb-5">
        <div class="col-5 text-center">
          <img class="w-100 m-5" src="image04.jpg"  alt="" style="box-shadow:33px 33px 0px -1px  #F8DDA8;">
      </div>
        <div class="col-7">
  ...
  <div class="row section4 mb-5">
    <div class="col-5 text-center">
      <img class="w-100 m-5" src="image06.jpg"  alt="" style="box-shadow:33px 33px 0px -1px  #F8DDA8;">
  </div>
    <div class="col-7">
...
<div class="row section4 mb-5">
  <div class="col-5 text-center">
    <img class="w-100 m-5" src="image08.jpg"  alt="" style="box-shadow:33px 33px 0px -1px  #F8DDA8;">
</div>
  <div class="col-7">
       ...
       <section class="p-contents04 mb-5">
        ...
        <section class="p-contents01" >
          ...
          <div class="c-section">		
            ...
            <h1 class="p-contents01__title"> キャンペーンの案内</h1><br>	
         
        <p class="p-contents03__txt">	
    
         
          <div class="row">
<div class="slideImg1 col" style="display: inline;  ">

    <!--<img class="w-100"  src="img24.jpg" />-->
    <img class="w-100" src="img27.jpg" style="  position: absolute;
    z-index: 10;">

</div>
<div class="col-10" style="border:5px solid #FCF787">
  <div class="row">
    <div class="col-2"></div>  	
    <div class="col-10">下記どちらか	<br>
      バッグ	<br>
      or	<br>
      フローティングミノー<br>	</div>	
  </div>
  <div class="row">
    ...
    <div class="col-10" style="word-break: break-word;">https://www.amazon.co.jp/Wild-Scene-%E3%83%AF%E3%82%A4%E3%83%AB%E3%83%89%E3%82%B7%E3%83%BC%E3%83%B3-%E3%83%95%E3%83%AD%E3%83%BC%E3%83%86%E3%82%A3%E3%83%B3%E3%82%B0%E3%83%9F%E3%83%8E%E3%83%BC-11-5cm/dp/B07YNHVVQB?ref_=ast_sto_dp	</div>	
    </div>		
    <div class="row">
      <div class="col-2">Twitter の拡散</div>  	
      <div class="col-10"><br>
        両方をもらえる。</div>	
      </div>	
</div>
...
<h3><b>Basic clothing and equipment</b><br></h3>
<div class="row mt-5">
  <div class="col-4">
    <div class="card">
      <div class="card-body">
        <div class="row">
          <div class="col-6"><img src="cap.svg" class="basicImg"></div>
          <div class="col-6 text-right cardTitle"><b>キャップ</b></div>
        </div>
       
        <div class="col-12">It is also necessary to avoid direct sunlight, and it also has the function of protecting the head so that the hook of the lure does not get stuck. Also, please be sure to cover it when going fishing with children. Since there are insects such as mosquitoes and flies in the summer outdoors, the cap is a must-have item.</div>
      </div>
    </div>
  </div>
  <div class="col-4">
    <div class="card">
      <div class="card-body">
        <div class="row">
          <div class="col-6"><img src="jacket.svg" class="basicImg"></div>
          <div class="col-6 text-right cardTitle"><b>Shirt</b></div>
        </div>
       
        <div class="col-12">Long-sleeved shirts are good for preventing insect bites and sunburn. (There are a lot of cheap, breathable, quick-drying, and cheap ones.) Furthermore, I would like to avoid exposing my skin as much as possible if I hit the skin with the sea breeze faster than usual.  </div>
    </div>
  </div>
  </div>
  <div class="col-4">
    <div class="card">
      <div class="card-body">
        <div class="row">
          <div class="col-6"><img src="underwear.svg" class="basicImg"></div>
          <div class="col-6 text-right cardTitle"><b>Underwear</b></div>
        </div>
        <div class="col-12">
          In order to sweat a lot in the summer, let's choose breathable and quick-drying clothes. And in winter it is better to wear heat-generating material. Le winter fishing lures are always in proper motion, so your body is always warm and you can concentrate on fishing.
         </div>
      </div>
    </div>
  </div>
...
<div class="row mt-5">
  <div class="col-4">
    <div class="card">
      <div class="card-body">
        <div class="row">
          <div class="col-6"><img src="jeans.svg" class="basicImg"></div>
          <div class="col-6 text-right cardTitle"><b>Pants</b></div>
        </div>
       
        <div class="col-12">Basically, you can use pants that you are familiar with, but choose those that are good for getting dirty. If possible, we recommend that you have functional and physical fit such as heat retention, breathability and quick-drying according to the season.</div>
      </div>
    </div>
  </div>
  <div class="col-4">
  ...
  <div class="col-4">
    <div class="card">
      <div class="card-body">
        <div class="row">
          <div class="col-6"><img src="bag.svg" class="basicImg"></div>
          <div class="col-6 text-right cardTitle"><b>Underwear</b></div>
        </div>
        <div class="col-12">
          In order to sweat a lot in the summer, let's choose breathable and quick-drying clothes. And in winter it is better to wear heat-generating material. Le winter fishing lures are always in proper motion, so your body is always warm and you can concentrate on fishing.
...
<div class="row mt-5">
  <div class="col-4">
    <div class="card">
      <div class="card-body">
        <div class="row">
          <div class="col-6"><img src="clock.svg" class="basicImg"></div>
          <div class="col-6 text-right cardTitle"><b>Pants</b></div>
        </div>
  ...
  <div class="col-4">
    <div class="card">
      <div class="card-body">
        <div class="row">
          <div class="col-6"><img src="trainers.svg" class="basicImg"></div>
          <div class="col-6 text-right cardTitle"><b>Shirt</b></div>
        </div>
  ...
  <div class="col-4">
    <div class="card">
      <div class="card-body">
        <div class="row">
          <div class="col-6"><img src="pliers.svg" class="basicImg"></div>
          <div class="col-6 text-right cardTitle"><b>Underwear</b></div>
        </div>
        <div class="col-12">
          In order to sweat a lot in the summer, let's choose breathable and quick-drying clothes. And in winter it is better to wear heat-generating material. Le winter fishing lures are always in proper motion, so your body is always warm and you can concentrate on fishing.
...
<div class="row mt-5">
  <div class="col-4">
    <div class="card">
      <div class="card-body">
        <div class="row">
          <div class="col-6"><img src="gloves.svg" class="basicImg"></div>
          <div class="col-6 text-right cardTitle"><b>Pants</b></div>
        </div>
  ...
  <div class="col-4">
    <div class="card">
      <div class="card-body">
        <div class="row">
          <div class="col-6"><img src="trousers.svg" class="basicImg"></div>
          <div class="col-6 text-right cardTitle"><b>Shirt</b></div>
        </div>
  ...
  <div class="col-4">
    <div class="card">
      <div class="card-body">
        <div class="row">
          <div class="col-6"><img src="raincoat.svg" class="basicImg"></div>
          <div class="col-6 text-right cardTitle"><b>Underwear</b></div>
        </div>
        <div class="col-12">
          In order to sweat a lot in the summer, let's choose breathable and quick-drying clothes. And in winter it is better to wear heat-generating material. Le winter fishing lures are always in proper motion, so your body is always warm and you can concentrate on fishing.
      ...
      <div class="row tabs">
        <div class="col-4">
          <div class="list-group" id="list-tab" role="tablist">
            <a class="list-group-item list-group-item-action active" id="list-home-list" data-toggle="list" href="#list-home" role="tab" aria-controls="home">Embankment</a>
            <a class="list-group-item list-group-item-action" id="list-profile-list" data-toggle="list" href="#list-profile" role="tab" aria-controls="profile">Port</a>
            <a class="list-group-item list-group-item-action" id="list-messages-list" data-toggle="list" href="#list-messages" role="tab" aria-controls="messages">Tetra</a>
            <a class="list-group-item list-group-item-action" id="list-settings-list" data-toggle="list" href="#list-settings" role="tab" aria-controls="settings">Surf</a>
            <a class="list-group-item list-group-item-action" id="list-kawaguchi-list" data-toggle="list" href="#list-kawaguchi" role="tab" aria-controls="kawaguchi">Kawaguchi</a>
            <a class="list-group-item list-group-item-action" id="list-jisso-list" data-toggle="list" href="#list-jisso" role="tab" aria-controls="jisso">Jisso</a>
          </div>
        </div>
        <div class="col-8">
          <div class="tab-content" id="nav-tabContent">
            <div class="tab-pane fade show active" id="list-home" role="tabpanel" aria-labelledby="list-home-list">Tab 1</div>
            <div class="tab-pane fade" id="list-profile" role="tabpanel" aria-labelledby="list-profile-list">Tab 2</div>
            <div class="tab-pane fade" id="list-messages" role="tabpanel" aria-labelledby="list-messages-list">Tetra is originally called generically from the wave-dissipating block, and it is said that the reason for installing it is mainly to prevent erosion due to waves. The size of Tetra grows in proportion to the size of the wave. Therefore, be aware that large waves, swells, and fast tides will flow where large tetras are installed. The risk is so high, so be careful. Tetra, which has a flat surface among the tetras, has a more stable scaffolding than the round shape, but on a windy day, the body becomes unstable, which is dangerous. Furthermore, Tetra, which is close to the sea, is very dangerous because it has thin seaweed and is slippery. Never ride on a particularly wet Tetra.</div>
            <div class="tab-pane fade" id="list-settings" role="tabpanel" aria-labelledby="list-settings-list">Tab 4</div>
            <div class="tab-pane fade" id="list-kawaguchi" role="tabpanel" aria-labelledby="list-kawaguchi-list">Tab 5</div>
            <div class="tab-pane fade" id="list-jisso" role="tabpanel" aria-labelledby="list-jisso-list">Tab 6</div>
          </div>
        </div>
      </div>
      </div>
