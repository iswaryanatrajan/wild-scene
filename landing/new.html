...
<!--<li><a href="https://wild-scene.com">New Menu<span>New Menu</span></a></li>-->
    ...
    <main class="index_area">
        ...
        <section class="p-kv pageHdr">
            ...
            <section class="p-intro"></section>
             <!--Content area -->
            <section class="p-contents01">
        
              <div class="c-section ">
                  <h1 class="p-contents01__title"><img src="sec3.png" width="846" height="234" alt="なぜ今ロケーションフォトウェディングなのか 「ナシ婚」の増加"><br>
               ...
               <!-- <ul class="p-contents01__block u-cf">
                ...
                <img src="sec4.jpg" />
                <h1 class="p-contents01__title" style="clear:both">
                ...
                <div class="row">
                  <h4 style="width:100%">ベストタイプ<br></h4>
                  <div class="col-6"><img src="pdtImg1.png" /></div>
                  <div class="col-6"><img src="pdtImg2.png" /></div>
                </div>
                <div class="row">
                  <h4 style="width:100%">腰巻タイプ<br></h4>
                  <div class="col-6"><img src="pdtImg3.png" /></div>
                  <div class="col-6"><img src="pdtImg4.png" /></div>
                </div>
                <div class="row">
                  <div class="col-12">
                    <p class="p-contents01__txt">
                      ライフジャケットの重要性は理解していても、サイズが大きすぎるとアウトドアの際に装着が不便に感じてしまうことでしょう。<br>			
                      ワイルドシーンのライフジャケットはスリムでコンパクトな設計にデザインされています。			<br>
                      <span class="redText">縦幅54cm×横幅33cmのサイズで、厚みは1cmです。</span>	<br><br>	
                      重さを徹底的に減らすよう追求し、本体重量をベストタイプ550g/ 腰巻タイプ750gにまで軽量化しました。だいたい500ミリリットルのペットボトルに近い重さです。		<br>	
                      フィット感を限りなく高めているので、さまざまな体勢や動きに追従しやすくなっています。その動きやすさは、まるでライフジャケットを装着していない状態です。<br>		
                      活発に動くウォータースポーツでも活用できます。	<br><br>		
          </p>	
        ...
        締め付けが悪いと水中に落ちたときに脱げてしまうケースがあるからです。水中でライフジャケットの位置を修正するのは困難であるため、事前の装着準備が重要です。股下ベルトがないライフジャケットは、腹回りのベルトを入念に締めるようにしましょう。<br>		
              ...
              <section class="p-contents03" style="background-color:#e3db5d;color: #9b9103;">
        
                <div class="c-section">			
        <h1 class="p-contents03__title" style="color: #9b9103;">■3D立体裁断&メッシュ構造で安全性を考慮した装備</h1>	<br>	
        <div class="row">
        <div class="col-6"><p class="p-contents03__txt" style="color: #9b9103;">	
          特筆すべきは最先端の加工技術である3D立体裁断が優れた吸着性能を発揮していることです。首や肩、胸部に柔軟に密着し、着用時の肩ずれやゴワツキなどの不快感を和らげられるようになっています。<br>		
          また、体に触れる部分がメッシュ構造になっているので、熱気を逃がしてくれます。蒸れにくいことから、真夏のアウトドアでも快適に装着できます。	<br></p></div>
        <div class="col-6"><img src="image01.jpg"/></div>
        </div>									
        <div class="row mt-3">
        <div class="col-6"><p class="p-contents03__txt" style="color: #9b9103;">	
        ライフジャケットが作動しても、救助されなければ意味がありません。場合によっては、声を張り上げても気づいてもらえないこともあるでしょう。		<br>
          ...
          夜間でも視認性を発揮してくれるので、ホイッスルを併用すれば暗闇の中でも発見される可能性が高くなると期待できます。		 <br>     	<br></p></div>
        <div class="col-6"><img src="img10.jpg"/></div>
        </div>
        </div>	
                ...
                <section class="p-contents03">
        
                        <div class="c-section">			
                <h1 class="p-contents03__title">●膨張方式</h1>	<br>										
                ...
                <div class="row m-4">
                    ...
                    <div class="col-6 "><h5 style="color: #2c7490;">下からの抽出<br></h5><img src="img11.jpg" /></div>
                    <div class="col-6"><h5 style="color: #2c7490;">お子さんが溺れないイメージ<br></h5><img src="img11.jpg" /></div>
                  </div>
                <p class="p-contents03__txt">一方、手動膨張式はライフジャケットに備わっているホースを使い自分で膨らませる必要があります。<br>
                  自動で膨張しないので誤作動のリスクが低く、水に濡れてしまうことがあるスポーツ（カヌー、水上スキー、サップフィッシング）などで活用できます。</p>
                    ...
                    <section class="p-kv">
                        <div class="c-section">
                            <!--<h1 class="p-contents04__title">装着スタイル</h1>-->
                            <div class="">
                                <img class="w-100" src="image02.jpg"  alt=""></h1>
                            </div>
        ...
        最もオーソドックスなのが、フロントのバックルで固定するタイプです。体型に応じて幅広いサイズをカバーできます。	<br>	
              ...
              <section class="p-contents05__blockTxt">
                    <div class="c-section">
                      <div class="p-contents05__title">
                        ■安全性が高い理由
                      </div>
                      <p>●安全性が高い理由1．妥協を許さない気室の開発</p>
        <br>
               <div class="row">
                 <div class="col-4">
                    <img class="w-100" src="image03.jpg"  alt="">
                 </div>
                 <div class="col-8">
               ...
               <br>	
               <p>●安全性が高い理由2．専用生産ラインにおける入念なチェック体制</p>
               <br>
               <div class="row">
                <div class="col-4">
                    <img class="w-100" src="image04.jpg"  alt="">
                </div>
                <div class="col-8">
                  ...
                  さらに、気室を外装に装着した後も改めて膨張テストを実施。最後まで実施される妥協のない検査こそ、ワイルドシーンのライフジャケットに安全性をもたらしています。</div>
              </div>
              <br>	
              <p>●安全性が高い理由3．2WAYタイプの自動膨張式</p>
              <br>
              <div class="row">
               <div class="col-4">
                <img class="w-100" src="image05.jpg"  alt="">
               </div>
               <div class="col-8">
        ...
        2WAYタイプの仕組みによって想定外を排除し、安全性を可能な限り高めているのです。 </div>
        </div>
        <br>	
        <p>●安全性が高い理由4．防水&UVカット性能で生地が劣化しにくい</p>
        <br>
        <div class="row">
         <div class="col-4">
            <img class="w-100" src="image06.jpg"  alt="">
         </div>
         <div class="col-8">
          ...
          このように、ワイルドシーンのライフジャケットは、水と光の影響まで考慮することで劣化を可能な限り防ぎ、安全性を追求しています。</div>
        </div>
        <br>	
        <p>●安全性が高い理由5．世界的メーカーによる各種装置を採用</p>
        <br>
        <div class="row">
         <div class="col-4">
            <img class="w-100" src="image07.jpg"  alt="">
         </div>
         <div class="col-8">
        ...
        この各種装置がワイルドシーンの安全性の基盤となっています。</div>
        </div>
        <br>	
        <p>●安全性が高い理由6．調節具には耐久性の高いポリアセタールを使用</p>
        <br>
        <div class="row">
         <div class="col-4">
            <img class="w-100" src="image08.jpg"  alt="">
         </div>
         <div class="col-8">
          ...
          調節具は小さな部分で、ライフジャケットの構成部品の中でも目にとどまりにくい部分かもしれません。ワイルドシーンのライフジャケットは、細部まで妥協なく安全性を追求しているのです。</div>
        </div>
        <br>	
        <p>●安全性が高い理由7．欧州規格CE取得製品<br>	</p>
        <br>
        <div class="row">
         <div class="col-4">
            <img class="w-100" src="image09.jpg"  alt="">
         </div>
         <div class="col-8">
          ...
          ワイルドシーンのライフジャケットは、このライセンス証明書にもとづいて販売され、安全性が証明されています。</div>
        </div>
             ...
             <section class="p-contents04">
              ...
              <div class="c-section">			
        <h1 class="p-contents01__title">■ライフジャケットが大切な命を守る	</h1>	<br>										
        ...
        ライフジャケットを準備して、これから明るい未来を築いていく子供を守ってください。<br>		
          ...
          <div class="row">
            ...
            <div class="col-8">
              <p class="p-contents04__txt">	<b>●釣り、サーフィン、ボートの転覆…多発する水難事故</b>
                <br>	
                日本では、痛ましい水難事故が多発しています。ボートの転覆による死亡事故や、サーフィン中に沖に流された事故などさまざまです。<br>	
                ...
                <br>	
                <b> ●令和元年における水難事故の発生状況</b><br>	
                <br>	
                警察庁生活安全局生活安全企画課は、令和元年に起きた全国の水難事故に関するデータを「令和元年における水難の概況（令和2年6月18日）」にまとめています。<br>	
                ...
                <br>	
                <b>●水難を回避するための対策は？</b><br>	
                <br>	
                警察庁生活安全局生活安全企画課は、水難を未然に防ぐためにはライフジャケットの活用を推進しています。特に、釣りやボートなどで水辺に行くときは、必ず着用することを促しています。その際は、体のサイズに合ったライフジャケットを選択し、正しい方法で着用することも重要とのことです。<br>	
          ...
          <section class="p-contents03" style="background-color:#000;color: #fff;">
        
            <div class="c-section">			
        <h1 class="p-contents03__title" style="
        color: #fff;">■ライフジャケットをつけることがマナーから義務に	</h1>	<br>										
        <p class="p-contents03__txt" style="
        color: #fff;">
        
          ライフジャケットの装着によって、生存率は本当に高まるのでしょうか？ライフジャケットの効果をはじめ、日本におけるライフジャケットの着用義務について紹介します。<br>	
          <br>	
         <b> ●ライフジャケットの効果</b><br>	
         <br>	
          ...
          ・防波堤内の係留船上にいる<br>	
          <br>	
          ライフジャケットを着用させる義務を怠った船長は、最大6か月にわたる免許停止の対象になることもあり、罰則が強化されつつあります。	</p><br>	
        </div>
        </section>
        ...
        <p class="p-contents04__txt">	警察庁もライフジャケットの重要性を呼びかけていることから、今後は乗船している最中だけでなく、水辺でのアウトドアでもマナーでは済まなくなるかもしれません。</p><br>	
        <br>
        <div class="text-center" ><img class="w-50" src="img25.jpg" />	</div><br>
        <h1 class="p-contents01__title">■最低限知っておきたいライフジャケットの選び方</h1>	<br>
        <p class="p-contents04__txt">
          水辺の危険性とライフジャケットの重要性を知った後に気になるのが、ライフジャケットの選び方でしょう。選ぶ際の基準をいくつか挙げてみます。<br>	
          <br>	
        <b>●安全性</b><br>	
        <br>	
        ライフジャケットを装着するのは命を守るためです。いかに見た目がおしゃれで動きやすいライフジャケットだとしても、品質が低ければ有事の際に機能しないこともありえます。<br>	
        
        したがって、ライフジャケットを選択するときは特に安全性の高さにこだわりましょう。最低限、法定基準を満たすライフジャケットを選択することが大切です。<br>	
        <br>	
        <b>■ワイルドシーンのライフジャケットで充実したアウトドアライフを！</b><br>	
        <br>	
        ...
        <div class="row">
          ...
          <div class="col-8">
            <p class="p-contents04__txt">ワイルドシーンのライフジャケットは世界的に信頼できるメーカーの部品を採用しているだけでなく、日本の法定基準を上回る安全性を有しています。<br>	
        
              ワイルドシーンのライフジャケットであれば、いずれのシチュエーションでも、自分だけではなく大切な家族や子供の命を守ることができます。<br>	
              
              これから水辺のアウトドアに出かける予定がある方、あるいは、お持ちのライフジャケットの性能に不安を感じている方は、ワイルドシーンのライフジャケットをぜひご活用ください。<br>	
              
              心置きなく快適なアウトドアライフを楽しむことができるでしょう。<br>	
              <br>	
              ・妥協を許さない気室の開発<br>	
        ...
        <section class="p-contents03" style="background-color:#e3db5d;color: #9b9103;">
          ...
          <div class="c-section">			
        <p class="p-contents03__txt" style="color: #9b9103;">	
          キャンペーンの案内（予約で購入してくれた場合下記全員にプレゼント）<br><br>
          <img class="" src="img27.jpg" /><br><br>
          <div class="row">
        <div class="col-2"></div>  	
        ...
        <div class="row">
          ...
          <div class="col-10">https://www.amazon.co.jp/Wild-Scene-%E3%83%AF%E3%82%A4%E3%83%AB%E3%83%89%E3%82%B7%E3%83%BC%E3%83%B3-%E3%83%95%E3%83%AD%E3%83%BC%E3%83%86%E3%82%A3%E3%83%B3%E3%82%B0%E3%83%9F%E3%83%8E%E3%83%BC-11-5cm/dp/B07YNHVVQB?ref_=ast_sto_dp	</div>	
          </div>		
          <div class="row">
        ...
        <section class="p-contents03" style="background-color: #c79292;color: #581b1b;">
          <h1 class="p-contents03__title text-center pt-5" style="
          color: #581b1b;">
            ～安全で充実したFISHING Lifeを応援します～</h1>	<br>
          <div class="c-section">	
            <div class="text-center" ><img class="w-50" src="image28.jpg" >	</div>
<br>	
         
        <p class="p-contents03__txt" style=" color: #581b1b;">	
...
<section class="p-contents03" style="background-color:#488b92;">
...
<div class="c-section">	
    <div class="text-center" ><img class="w-50"  src="image29.jpg" />	</div>
<br>
<p class="p-contents03__txt" style="color: #fff;">釣行前には必ずテレビのニュースはもちろんのこと、パソコンやスマートフォンで気象情報を確認しておき、せめて自分が行こうとしているポイント周辺に警報や注意報が出ていないかを見ておきましょう。もし該当すればポイントを変更するか、日を改めて下さい。
<br><br>
また地震などの自然災害では、いつ発生するか予測不能な部分はあります。しかし最近では地震速報など、スマートフォンにいち早くアラーム音で知らせてくれます。発生したら地震の大きさに関係なく、まず津波がくることを前提としてすぐ海から離れましょう。
<br><br> 

<b>【海で釣りをするための基本装備と準備について】</b>
<div class="c-section">	
<br>
...
<b>【基本の服装と装備】</b><br>
<div class="text-center" ><img class="w-50"  src="image30.jpg" />	</div><br> 
<br>


◆キャップ・・・直射日光を避ける為にも必要ですし、ルアーのフックが刺さったりしないように頭を守る働きもあります。また子どもと一緒に釣りに出かける時は必ず被らせて下さい。夏の野外は蚊やアブなどの虫もいますのでキャップは必須装備です。	<br><br>

◆偏光グラス・・・光の乱反射を抑え、目を守る役目もあります。水中の様子が見やすくなるメリットがあります。	<br><br>

◆シャツ・・・虫刺され防止、日焼け予防に長袖シャツが良いでしょう。（通気性が良く、速乾性のある安価なものは探せばたくさんありますよ。）さらに肌に潮風が直接当たると体力が通常より早く奪われるという観点から露出は極力避けたいです。	<br><br>

◆アンダーウエア・・・夏はたくさんの汗をかくためにやはり通気性＆速乾性が高いものを選びましょう。そして冬は発熱素材のウエアを着用した方が良いです。ル冬のルアー釣りでは常時適度な動きをしている為、常に体が暖かくて釣りに集中出来ます。	<br><br>

◆パンツ・・・基本的には履き慣れたもので構いませんが、汚れても良いものを選びましょう。出来れば季節に合わせた保温性や通気性・速乾性などの機能的で体に合うものがオススメです。	<br><br>

◆バッグ・・・必要なアイテムをコンパクトにまとめてバッグに入れておける為、釣りの邪魔にならない為便利なアイテムです。リュックタイプやショルダータイプを選びましょう。	<br><br>

◆ライフジャケット・・・釣行時は必ずライフジャケット（フローティングゲームベスト）を着用しましょう。フローティングゲームベストは浮力体だけではなく、ルアーやラインを収納可能で、手に持つものを少なく出来るためルアー釣り等では必須アイテムになります。	<br><br>

◆時計・・・最近の時計はただ時間を見る為だけのものではなくて、コンパス機能付きで方位が分かる時計や、電話機能付きだったり、さらに潮見表機能が付いているものもあります。もちろん時計は防水機能なものを選びましょうね。	<br><br>

◆シューズ・・・釣りの最中はつい夢中になり足元がぬかるんでいることに気づかなくて転倒したりする危険性があります。釣りに行く時は靴底が滑りにくいシューズを履いていきましょう。特に磯場など足場が悪いことが分かっているところでは専用のスパイクシューズが絶対です。	<br><br>

◆小物類・・・狙うターゲットにもよりますが、魚のヒレや歯、毒を持つ魚など怪我をする恐れがあるので、魚を掴む道具や針のフックを外すプライヤーがあった方が安全に釣りをする事が出来ます。	<br><br>

◆手袋・・・濡れた手でロッドを握っても滑らない手袋があると便利。またグリップ性のある素材で指先が出るようにカットされた手袋もある。ルアーの針で手が傷つく心配も無いですし、真冬は防寒対策にもなります。	<br><br>

◆ウェーダー・・・浅瀬に下りて釣りをする場合や低い磯場・波が高い日はこのウェーダーがあると便利です。	<br><br>

◆レインウエア・・・雨の日には必ず必要になります。また突然のにわか雨などにも備えて事前に用意はしておきましょう。ビニール製の安価なものよりも、ムレない素材で防水性の高いウエアを選びましょう。もちろん安価なビニール製よりも値段は高くなりますが、こっちのほうが快適です。<br><br>	


<b>【各フィールドの基礎知識と注意点について】</b><br><br>
